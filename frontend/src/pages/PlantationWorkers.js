...
const overallCashNotes = calculateNotes(totals.balance);
      ...
      {/* DAILY ATTENDANCE */}
        ...
        <ResponsiveCard>
          ...
          <ResponsiveCard>
            ...
            >
              Total Cash: Rs. {Number(totals.balance).toFixed(2)}
            </Typography>
        ...
        <Table>
          <TableHead>
            <TableRow>
              ...
              <TableCell sx={{ color: "#aaa" }}>Cash Notes</TableCell>
